...
class Tier1(object):
    ...
    def __init__(self, name=None, description=None, tier_level=None, attributes=None, request_count=None, unit_time=None, tier_plan=None, stop_on_quota_reach=None):
        """
        Tier1 - a model defined in Swagger
        """
    ...
    def name(self):
        """
        Gets the name of this Tier1.

        :return: The name of this Tier1.
        :rtype: str
        """
        return self._name
    ...
    def name(self, name):
        """
        Sets the name of this Tier1.

        :param name: The name of this Tier1.
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """
        Gets the description of this Tier1.

        :return: The description of this Tier1.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this Tier1.

        :param description: The description of this Tier1.
        :type: str
        """
    ...
    def tier_level(self):
        """
        Gets the tier_level of this Tier1.

        :return: The tier_level of this Tier1.
        :rtype: str
        """
    ...
    def tier_level(self, tier_level):
        """
        Sets the tier_level of this Tier1.

        :param tier_level: The tier_level of this Tier1.
        :type: str
        """
    ...
    def attributes(self):
        """
        Gets the attributes of this Tier1.
        Custom attributes added to the tier policy 

        :return: The attributes of this Tier1.
        :rtype: dict(str, str)
        """
    ...
    def attributes(self, attributes):
        """
        Sets the attributes of this Tier1.
        Custom attributes added to the tier policy 

        :param attributes: The attributes of this Tier1.
        :type: dict(str, str)
        """
    ...
    def request_count(self):
        """
        Gets the request_count of this Tier1.
        Maximum number of requests which can be sent within a provided unit time 

        :return: The request_count of this Tier1.
        :rtype: int
        """
    ...
    def request_count(self, request_count):
        """
        Sets the request_count of this Tier1.
        Maximum number of requests which can be sent within a provided unit time 

        :param request_count: The request_count of this Tier1.
        :type: int
        """
    ...
    def unit_time(self):
        """
        Gets the unit_time of this Tier1.

        :return: The unit_time of this Tier1.
        :rtype: int
        """
    ...
    def unit_time(self, unit_time):
        """
        Sets the unit_time of this Tier1.

        :param unit_time: The unit_time of this Tier1.
        :type: int
        """
    ...
    def tier_plan(self, tier_plan):
        """
        Sets the tier_plan of this Tier1.
        This attribute declares whether this tier is available under commercial or free 

        :param tier_plan: The tier_plan of this Tier1.
        :type: str
        """
    ...
    def stop_on_quota_reach(self):
        """
        Gets the stop_on_quota_reach of this Tier1.
        ...
        :return: The stop_on_quota_reach of this Tier1.
        :rtype: bool
        """
    ...
    def stop_on_quota_reach(self, stop_on_quota_reach):
        """
        Sets the stop_on_quota_reach of this Tier1.
        If this attribute is set to false, you are capabale of sending requests even if the request count exceeded within a unit time 

        :param stop_on_quota_reach: The stop_on_quota_reach of this Tier1.
        :type: bool
        """
