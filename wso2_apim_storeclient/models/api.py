...
class API(object):
    ...
    def context(self, context):
        """
        Sets the context of this API.

        :param context: The context of this API.
        :type: str
        """
        if context is None:
    ...
    def provider(self):
        """
        Gets the provider of this API.
        If the provider value is not given user invoking the api will be used as the provider. 

        :return: The provider of this API.
        :rtype: str
        """
    ...
    def provider(self, provider):
        """
        Sets the provider of this API.
        If the provider value is not given user invoking the api will be used as the provider. 

        :param provider: The provider of this API.
        :type: str
        """
        if provider is None:
    ...
    def api_definition(self):
        """
        Gets the api_definition of this API.
        Swagger definition of the API which contains details about URI templates and scopes 

        :return: The api_definition of this API.
        :rtype: str
        """
    ...
    def api_definition(self, api_definition):
        """
        Sets the api_definition of this API.
        Swagger definition of the API which contains details about URI templates and scopes 

        :param api_definition: The api_definition of this API.
        :type: str
        """
    ...
    def wsdl_uri(self):
        """
        Gets the wsdl_uri of this API.
        WSDL URL if the API is based on a WSDL endpoint 

        :return: The wsdl_uri of this API.
        :rtype: str
        """
    ...
    def wsdl_uri(self, wsdl_uri):
        """
        Sets the wsdl_uri of this API.
        WSDL URL if the API is based on a WSDL endpoint 

        :param wsdl_uri: The wsdl_uri of this API.
        :type: str
        """
    ...
    def is_default_version(self):
        """
        Gets the is_default_version of this API.

        :return: The is_default_version of this API.
        :rtype: bool
        """
    ...
    def is_default_version(self, is_default_version):
        """
        Sets the is_default_version of this API.

        :param is_default_version: The is_default_version of this API.
        :type: bool
        """
    ...
    def transport(self):
        """
        Gets the transport of this API.

        :return: The transport of this API.
        :rtype: list[str]
        """
    ...
    def transport(self, transport):
        """
        Sets the transport of this API.

        :param transport: The transport of this API.
        :type: list[str]
        """
    ...
    def tiers(self):
        """
        Gets the tiers of this API.

        :return: The tiers of this API.
        :rtype: list[str]
        """
        return self._tiers
    ...
    def tiers(self, tiers):
        """
        Sets the tiers of this API.

        :param tiers: The tiers of this API.
        :type: list[str]
        """
    ...
    def thumbnail_url(self):
        """
        Gets the thumbnail_url of this API.

        :return: The thumbnail_url of this API.
        :rtype: str
        """
    ...
    def thumbnail_url(self, thumbnail_url):
        """
        Sets the thumbnail_url of this API.

        :param thumbnail_url: The thumbnail_url of this API.
        :type: str
        """
    ...
    def endpoint_ur_ls(self):
        """
        Gets the endpoint_ur_ls of this API.

        :return: The endpoint_ur_ls of this API.
    ...
    def endpoint_ur_ls(self, endpoint_ur_ls):
        """
        Sets the endpoint_ur_ls of this API.

        :param endpoint_ur_ls: The endpoint_ur_ls of this API.
    ...
    def business_information(self):
        """
        Gets the business_information of this API.

        :return: The business_information of this API.
    ...
    def business_information(self, business_information):
        """
        Sets the business_information of this API.

        :param business_information: The business_information of this API.
