...
from wso2_apim_storeclient.apis.document_individual_api import DocumentIndividualApi
...
class TestDocumentIndividualApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = wso2_apim_storeclient.apis.document_individual_api.DocumentIndividualApi()
